...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (lastMessage !== null) {
      ...
      else if (lastMessage.data == "Message sent") {
  ...
  async function sendMess(e) {
    ...
    let reciever = "0271b012d6238af8e689c3d3a1f400f4b429556cdce5834cc21903f7e5b1971783";
    let encryptData = encrypt(reciever, message)
    console.log(encryptData.toString("hex"))

    let data = {
      user: "0271b012d6238af8e689c3d3a1f400f4b429556cdce5834cc21903f7e5b1971783",
      cipher: "helfdslo",
      receive: false
    }
    ...
    sendMessage(JSON.stringify({ cipher: encryptData.toString("hex"), public_key: "0271b012d6238af8e689c3d3a1f400f4b429556cdce5834cc21903f7e5b1971783" }))
